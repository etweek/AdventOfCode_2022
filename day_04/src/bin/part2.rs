...
fn main() {
    ...
    for line in input_lines.iter(){
        ...
        // do the checking
        if contains_part_range(first_elf[0], first_elf[1], second_elf[0], second_elf[1]) ||
            contains_part_range(second_elf[0], second_elf[1], first_elf[0], first_elf[1]){
                sum += 1;
            }
    }
...
fn contains_part_range(start1:i32, end1:i32, start2:i32, end2:i32) -> bool{
